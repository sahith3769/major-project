...
const PredictDiseaseFromImageOutputSchema = z.object({
  predictedDisease: z.string().describe('The predicted skin disease. Possible values are "Cellulitis", "Impetigo", "Athlete\'s Foot", "Nail Fungus", or "Inappropriate image".'),
...
const prompt = ai.definePrompt({
  ...
  The ONLY possible skin disease predictions are: "Cellulitis", "Impetigo", "Athlete's Foot", "Nail Fungus".
  ...
  - If the image IS a human skin condition, then analyze it using the simulated characteristics of the selected model and predict one of the allowed diseases:
    ...
    1.  'predictedDisease': The most likely skin condition from the allowed list: "Cellulitis", "Impetigo", "Athlete's Foot", "Nail Fungus".
